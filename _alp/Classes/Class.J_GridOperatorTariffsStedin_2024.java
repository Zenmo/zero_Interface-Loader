/**
 * J_GridOperatorTariffsStedin_2024
 */
...
public class J_GridOperatorTariffsStedin_2024 implements I_GridOperatorTariffs {
	//Data source: https://www.acm.nl/system/files/documents/tarievenblad-stedin-elektriciteit-2024.xlsx   (Bijlage 2a + 2b bij Tarievenbesluit Elektriciteit 2024 Stedin)
	//			&& https://www.stedin.net/tarieven/download-tarieven  (kleinverbruik tariefblad 2024, tabel Metertarieven)
	...
	double measurementServiceCostSmallConnection_eurpday = 30.16/365;	//meetdienst 30.16 EUR/jaar
	...
	Map<String, Double> periodicalPhyscialConnectionCapacityCostsTable_eurpyr = Map.ofEntries(
			Map.entry("t/m 1 x 6 A (geschakeld)", 13.1698 + 30.16),
			Map.entry("t/m 1 x 10 A", 35.4897 + 30.16),
			Map.entry("> 1 x 10 A t/m 3 x 25 A", 35.4897 + 30.16),
			Map.entry("> 3 x 25 A t/m 3 x 35 A", 58.2114 + 30.16),
			Map.entry("> 3 x 35 A t/m 3 x 50 A", 58.2114 + 30.16),
			Map.entry("> 3 x 50 A t/m 3 x 63 A", 58.2114 + 30.16),
			Map.entry("> 3 x 63 A t/m 3 x 80 A", 58.2114 + 30.16),
			Map.entry("> 3 x 80 A t/m 175 kVA", 126.9499),
			Map.entry("> 175 kVA t/m 1.750 kVA", 1137.9634),
			Map.entry("> 1.750 kVA t/m 5 MVA", 2762.0473),
			Map.entry("> 5 MVA t/m 10 MVA", 13653.3117),
			Map.entry("> 10 MVA", 13653.3117)
			);

	Map<String, Double> transportCostsTable_smallConnections_eurpday = Map.ofEntries(
			Map.entry("t/m 1 x 6 A (geschakeld)", 3.335/365),
			Map.entry("t/m 1 x 10 A", 33.35/365),
			Map.entry("> 1 x 10 A t/m 3 x 25 A", 266.8/365),
			Map.entry("> 3 x 25 A t/m 3 x 35 A", 1334.0/365),
			Map.entry("> 3 x 35 A t/m 3 x 50 A", 2001.0/365),
			Map.entry("> 3 x 50 A t/m 3 x 63 A", 2668.0/365),
			Map.entry("> 3 x 63 A t/m 3 x 80 A", 3335.0/365)
			);

	Map<String, Double> transportCostsTable_largeConnections_normalTarif_eurpkWh = Map.ofEntries(
			Map.entry("LS (contract vermogen t/m 50 kW)", 0.0685),
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 150 kW)", 0.0176),
			Map.entry("MS (contract vermogen meer dan 150 kW t/m 1500 kW)", 0.0176),
	...
	Map<String, Double> transportCostsTable_largeConnections_lowTarif_eurpkWh = Map.ofEntries( //Between 23:00 and 7:00
			Map.entry("LS (contract vermogen t/m 50 kW)", 0.0419),
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 150 kW)", 0.0176),
			Map.entry("MS (contract vermogen meer dan 150 kW t/m 1500 kW)", 0.0176),
			Map.entry("Trafo HS+TS/MS > 1500 kW", 0.0),
			Map.entry("TS > 1500 kW", 0.0)
	...
	Map<String, Double> maxPeakPowerCostsTable_eurpkWpmonth = Map.ofEntries(
			...
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 150 kW)", 2.8524),
			Map.entry("MS (contract vermogen meer dan 150 kW t/m 1500 kW)", 2.8524),
			Map.entry("Trafo HS+TS/MS > 1500 kW", 4.7185),
			Map.entry("TS > 1500 kW", 3.8765)
			);
	Map<String, Double> contractCapacityCostsTable_eurpkWpyr = Map.ofEntries(
			Map.entry("LS (contract vermogen t/m 50 kW)", 17.0501),
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 150 kW)", 43.1),
			Map.entry("MS (contract vermogen meer dan 150 kW t/m 1500 kW)", 23.0),
			Map.entry("Trafo HS+TS/MS > 1500 kW", 42.4476),
			Map.entry("TS > 1500 kW", 33.4616)
			);
     ...
     * Default constructor
     */
    public J_GridOperatorTariffsStedin_2024() {
    }
