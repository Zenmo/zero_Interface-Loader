/**
 * J_GridOperatorTariffsEnexis_2024
 */
...
public class J_GridOperatorTariffsEnexis_2024 implements I_GridOperatorTariffs {
	//Data source: https://www.acm.nl/system/files/documents/tarievenblad-enexis-elektriciteit-2024.xlsx   (Bijlage 2a + 2b bij Tarievenbesluit Elektriciteit 2024 Enexis)
	//			&& https://www.enexis.nl/tarieven/oudere-tarieven  (kleinverbruik tariefblad 2024, meetdienst EUR/dag)
	...
	double measurementServiceCostSmallConnection_eurpday = 0.07062;	//meetdienst, gepubliceerd per dag
	...
	Map<String, Double> periodicalPhyscialConnectionCapacityCostsTable_eurpyr = Map.ofEntries(
			Map.entry("t/m 1 x 10 A (onbemeten)", 31.2),
			Map.entry("t/m 1 x 10 A", 31.2 + 25.7763),
			Map.entry("> 1 x 10 A t/m 3 x 25 A / 1 x 80 A (onbemeten)", 31.2),
			Map.entry("> 1 x 10 A t/m 3 x 25 A / 1 x 80 A", 31.2 + 25.7763),
			Map.entry("> 3 x 25 A t/m 3 x 35 A", 40.63 + 25.7763),
			Map.entry("> 3 x 35 A t/m 3 x 50 A", 40.63 + 25.7763),
			Map.entry("> 3 x 50 A t/m 3 x 63 A", 40.63 + 25.7763),
			Map.entry("> 3 x 63 A t/m 3 x 80 A", 40.63 + 25.7763),
			Map.entry("> 3 x 80 A t/m 3 x 250 A (173 kVA)", 311.0),
			Map.entry("> 3 x 250 A (173 kVA) t/m 1.750 kVA", 1192.0),
			Map.entry("> 1.750 kVA t/m 3 MVA", 3288.0),
			Map.entry("> 3 MVA t/m 6 MVA", 3288.0),
			Map.entry("> 6 MVA t/m 10 MVA", 3834.0),
			Map.entry("> 10 MVA", 3834.0),
			Map.entry("> 6 MVA N-0 t/m 10 MVA N-0", 3834.0)
			);

	Map<String, Double> transportCostsTable_smallConnections_eurpday = Map.ofEntries(
			Map.entry("t/m 1 x 10 A (onbemeten)", 34.73/365),
			Map.entry("t/m 1 x 10 A", 34.73/365),
			Map.entry("> 1 x 10 A t/m 3 x 25 A / 1 x 80 A (onbemeten)", 277.84/365),
			Map.entry("> 1 x 10 A t/m 3 x 25 A / 1 x 80 A", 277.84/365),
			Map.entry("> 3 x 25 A t/m 3 x 35 A", 1389.2/365),
			Map.entry("> 3 x 35 A t/m 3 x 50 A", 2083.8/365),
			Map.entry("> 3 x 50 A t/m 3 x 63 A", 2778.4/365),
			Map.entry("> 3 x 63 A t/m 3 x 80 A", 3473.0/365)
			);

	Map<String, Double> transportCostsTable_largeConnections_normalTarif_eurpkWh = Map.ofEntries(
			Map.entry("LS (contract vermogen t/m 50 kW)", 0.0688),
			Map.entry("MS/LS (contract vermogen meer dan 50 kW t/m 125 kW)", 0.0206),
			Map.entry("MS-D (contract vermogen meer dan 125 kW t/m 1500 kW)", 0.0206),
			Map.entry("MS-D > 1500 kW", 0.0206),
			Map.entry("MS-T > 1500 kW", 0.0128),
	...
	Map<String, Double> transportCostsTable_largeConnections_lowTarif_eurpkWh = Map.ofEntries( //Between 23:00 and 7:00
			Map.entry("LS (contract vermogen t/m 50 kW)", 0.036),
			Map.entry("MS/LS (contract vermogen meer dan 50 kW t/m 125 kW)", 0.0206),
			Map.entry("MS-D (contract vermogen meer dan 125 kW t/m 1500 kW)", 0.0206),
			Map.entry("MS-D > 1500 kW", 0.0206),
			Map.entry("MS-T > 1500 kW", 0.0128),
	...
	Map<String, Double> maxPeakPowerCostsTable_eurpkWpmonth = Map.ofEntries(
			...
			Map.entry("MS/LS (contract vermogen meer dan 50 kW t/m 125 kW)", 3.14),
			Map.entry("MS-D (contract vermogen meer dan 125 kW t/m 1500 kW)", 3.14),
			Map.entry("MS-D > 1500 kW", 3.14),
			Map.entry("MS-T > 1500 kW", 2.6),
			Map.entry("HS/MS > 1500 kW", 3.81),
			Map.entry("TS > 1500 kW", 3.22)
			);
	Map<String, Double> contractCapacityCostsTable_eurpkWpyr = Map.ofEntries(
			Map.entry("LS (contract vermogen t/m 50 kW)", 14.93),
			Map.entry("MS/LS (contract vermogen meer dan 50 kW t/m 125 kW)", 44.84),
			Map.entry("MS-D (contract vermogen meer dan 125 kW t/m 1500 kW)", 26.47),
			Map.entry("MS-D > 1500 kW", 26.47),
			Map.entry("MS-T > 1500 kW", 24.19),
			Map.entry("HS/MS > 1500 kW", 37.2),
			Map.entry("TS > 1500 kW", 26.89)
			);
     ...
     * Default constructor
     */
    public J_GridOperatorTariffsEnexis_2024() {
    }
