/**
 * J_GridOperatorTariffsLiander_2023
 */
...
public class J_GridOperatorTariffsLiander_2023 implements I_GridOperatorTariffs {
	//Data source: https://www.acm.nl/system/files/documents/tarievenblad-liander-elektriciteit-2023.xlsx   (Bijlage 2a + 2b bij Tarievenbesluit Elektriciteit 2023 Liander)
	//			&& https://www.liander.nl/tarieven  (kleinverbruik tariefblad 2023, sectie Meetdienst)
	...
	double measurementServiceCostSmallConnection_eurpday = 16.1695/365;	//meetdienst 16.1695 EUR/jaar
	...
	Map<String, Double> periodicalPhyscialConnectionCapacityCostsTable_eurpyr = Map.ofEntries(
			Map.entry("t/m 1 x 6 A (geschakeld)", 9.782 + 16.1695),
			Map.entry("t/m 1 x 10 A", 24.3455 + 16.1695),
			Map.entry("> 1 x 10 A t/m 3 x 25 A", 24.3455 + 16.1695),
			Map.entry("> 3 x 25 A t/m 3 x 35 A", 32.85 + 16.1695),
			Map.entry("> 3 x 35 A t/m 3 x 50 A", 32.85 + 16.1695),
			Map.entry("> 3 x 50 A t/m 3 x 63 A", 38.471 + 16.1695),
			Map.entry("> 3 x 63 A t/m 3 x 80 A", 38.471 + 16.1695),
			Map.entry("> 3 x 80 A t/m 100 kVA", 156.48),
			Map.entry("> 100 kVA t/m 160 kVA", 175.2),
			Map.entry("> 160 kVA t/m 1.000 kVA", 643.56),
			Map.entry("> 1.000 kVA t/m 2 MVA", 1222.92),
			Map.entry("> 2 MVA t/m 5 MVA", 8256.0),
			Map.entry("> 5 MVA t/m 10 MVA", 9816.0),
			Map.entry("> 10 MVA", 9816.0)
			);

	Map<String, Double> transportCostsTable_smallConnections_eurpday = Map.ofEntries(
			Map.entry("t/m 1 x 6 A (geschakeld)", 2.847/365),
			Map.entry("t/m 1 x 10 A", 28.47/365),
			Map.entry("> 1 x 10 A t/m 3 x 25 A", 227.76/365),
			Map.entry("> 3 x 25 A t/m 3 x 35 A", 1138.8/365),
			Map.entry("> 3 x 35 A t/m 3 x 50 A", 1708.2/365),
			Map.entry("> 3 x 50 A t/m 3 x 63 A", 2277.6/365),
			Map.entry("> 3 x 63 A t/m 3 x 80 A", 2847.0/365)
			);

	Map<String, Double> transportCostsTable_largeConnections_normalTarif_eurpkWh = Map.ofEntries(
			Map.entry("LS (contract vermogen t/m 50 kW)", 0.0542),
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 136 kW)", 0.016),
			Map.entry("MS (contract vermogen meer dan 136 kW t/m 2 MW)", 0.016),
	...
	Map<String, Double> transportCostsTable_largeConnections_lowTarif_eurpkWh = Map.ofEntries( //Between 23:00 and 7:00
			Map.entry("LS (contract vermogen t/m 50 kW)", 0.0287),
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 136 kW)", 0.016),
			Map.entry("MS (contract vermogen meer dan 136 kW t/m 2 MW)", 0.016),
			Map.entry("Trafo HS+TS/MS > 2 MW", 0.0),
			Map.entry("TS > 2 MW", 0.0),
	...
	Map<String, Double> maxPeakPowerCostsTable_eurpkWpmonth = Map.ofEntries(
			...
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 136 kW)", 2.59),
			Map.entry("MS (contract vermogen meer dan 136 kW t/m 2 MW)", 2.59),
			Map.entry("Trafo HS+TS/MS > 2 MW", 4.06),
			Map.entry("TS > 2 MW", 3.75),
			Map.entry("HS > 2 MW", 1.87)
			);
	Map<String, Double> contractCapacityCostsTable_eurpkWpyr = Map.ofEntries(
			Map.entry("LS (contract vermogen t/m 50 kW)", 12.96),
			Map.entry("Trafo MS/LS (contract vermogen meer dan 50 kW t/m 136 kW)", 34.56),
			Map.entry("MS (contract vermogen meer dan 136 kW t/m 2 MW)", 21.84),
			Map.entry("Trafo HS+TS/MS > 2 MW", 35.04),
			Map.entry("TS > 2 MW", 34.68),
			Map.entry("HS > 2 MW", 18.0)
			);
     ...
     * Default constructor
     */
    public J_GridOperatorTariffsLiander_2023() {
    }
