...
public class J_InfoText implements Serializable {
	...
	public String companyRooftopPV = "Met deze slider kun je instellen welk aandeel van de bedrijven zonnepanelen op hun dak heeft liggen. Het aantal zonnepanelen wordt geschaald naar het dak oppervlak van het bedrijf. De minimum waarde van de slider is gezet op de hoveelheid die al in het huidige scenario aanwezig is.";
	...
	public String householdPrivateParking = "?";
	public String householdPublicParking = "?";
